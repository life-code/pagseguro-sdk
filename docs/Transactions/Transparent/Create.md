...
## Create Transparent Payment transaction documentation
...
// Create instance of PagSeguro\Transactions\Payment::class
...
$method      = new \PagSeguro\Transactions\Method();
$holder      = new \PagSeguro\Transactions\CreditCard\Holder();
$credit_card = new \PagSeguro\Transactions\CreditCard\CreditCard();
$documents   = new \PagSeguro\Common\Documents();
$address     = new \PagSeguro\Common\Address();
$phone       = new \PagSeguro\Common\Phone();
$installment = new \PagSeguro\Transactions\CreditCard\Installment();
